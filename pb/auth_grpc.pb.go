...
const (
	AuthService_GetToken_FullMethodName = "/grpc.proto.auth.AuthService/GetToken"
)
...
type AuthServiceClient interface {
	GetToken(ctx context.Context, in *LoginReq, opts ...grpc.CallOption) (*LoginResp, error)
}
...
func (c *authServiceClient) GetToken(ctx context.Context, in *LoginReq, opts ...grpc.CallOption) (*LoginResp, error) {
...
type AuthServiceServer interface {
	GetToken(context.Context, *LoginReq) (*LoginResp, error)
...
func (UnimplementedAuthServiceServer) GetToken(context.Context, *LoginReq) (*LoginResp, error) {
...
func _AuthService_GetToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).GetToken(ctx, req.(*LoginReq))
	}
